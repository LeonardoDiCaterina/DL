...
from augmentation import rename_and_save
...
if __name__ == '__main__':
    ...
    for index_dir,fold in enumerate(folds):
        ...
        logger.info(f"Renaming and saving fold {index_dir}")
        # fold is a list of tuples (path, label)
        rename_and_save(fold,DATA_DIR, fold_dir, oversample=OVERSAMPLE)
    ...
    rename_and_save(test_df, DATA_DIR, fold_dir, oversample=OVERSAMPLE)
